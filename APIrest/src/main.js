...
const nameD = "TEST";
const url=`mongodb+srv://Ramadan3316:${password}@mongodata.vxtbq.mongodb.net/?retryWrites=true&w=majority`;
//{ useNewUrlParser: true, useUnifiedTopology: true }
mongoose.connect(url     //Para que no nos tiren errores en la consola
).then(()=> console.log("Mongo Conectado"))
    .catch((e)=> console.log("El eror es: ",e));

//Configuraciones
app.set("port",3000); // Si el servidor me da un puerto uso ese si no el 3000
